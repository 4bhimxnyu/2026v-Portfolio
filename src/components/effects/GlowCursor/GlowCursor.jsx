...
const GlowCursor = ({
  ...
  useEffect(() => {
    ...
    let raf = 0;
    let destroyed = false;
    // Portfolio addition: sleep while off-screen or fully faded, wake on input.
    let visible = true;
    const wake = () => {
    ...
    const render = now => {
      ...
      const asleep = fadeTarget === 0 && fade < 0.002;
      raf = !destroyed && visible && !asleep ? requestAnimationFrame(render) : 0;
    };
